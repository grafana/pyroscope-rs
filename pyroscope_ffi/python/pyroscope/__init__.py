...
def configure(application_name=None, server_address="http://localhost:4040", auth_token = "", sample_rate=100, detect_subprocesses=False, oncpu=False, native=False, gil_only=False, log_level="info", tags=None): 
