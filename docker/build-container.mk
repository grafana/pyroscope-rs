...
REGISTRY_CACHE_VOLUME    := pyroscope-rs-cargo-registry-cache
...
REGISTRY_CACHE_EXISTS    := $(call volume_exists,$(REGISTRY_CACHE_VOLUME))

ifeq ($(REGISTRY_CACHE_EXISTS),1)
DOCKER_OPTS += -v $(REGISTRY_CACHE_VOLUME):/root/.cargo/registry
endif
endif

.PHONY: build-container-cache
build-container-cache:
	docker volume create $(REGISTRY_CACHE_VOLUME)

clean-build-container-cache:
ifneq (, $(shell which docker))
	docker volume rm $(REGISTRY_CACHE_VOLUME) 2>/dev/null || true
endif
